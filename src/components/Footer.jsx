  ...
  return (
    <footer className='bg-gray-800' aria-labelledby='footer-heading'>
      ...
      <div className='mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8'>
        ...
        {/*      <button*/}
        {/*        type='submit'*/}
        {/*        className='flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-500 py-2 px-4 text-base font-medium text-white hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-gray-800'*/}
        {/*      >*/}
        {/*        Subscribe*/}
        {/*      </button>*/}
        {/*    </div>*/}
        ...
        <div className='mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between'>
          ...
          <p className='mt-8 text-base text-gray-400 md:order-1 md:mt-0'>
            &copy; 2022 Lastfootprint, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
